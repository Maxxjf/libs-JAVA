package com.qcloud.qclib.widget.indicator;
...
import com.qcloud.qclib.widget.indicator.viewpager.FragmentListPageAdapter;
import com.qcloud.qclib.widget.indicator.viewpager.GViewPager;
import com.qcloud.qclib.widget.indicator.viewpager.RecyclingPagerAdapter;

/**
 * 类说明：将indicatorView，ViewPager联合使用
 * Author: Kuzan
 * Date: 2017/8/11 10:30.
 */
    ...
    protected void iniOnItemSelectedListener() {
        indicatorView.setOnItemSelectListener(new Indicator.OnItemSelectedListener() {
            ...
            public void onItemSelected(View selectItemView, int select, int preSelect) {
                if (viewPager instanceof GViewPager) {
                    viewPager.setCurrentItem(select, ((GViewPager) viewPager).isCanScroll());
                } else {
