 ...
 */
public class LinearClearLayout extends LinearLayout implements IClearRootView {
    ...
    public LinearClearLayout(Context context) {
        this(context, null);
    }

    public LinearClearLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public LinearClearLayout(Context context, AttributeSet attrs, int defStyle) {
