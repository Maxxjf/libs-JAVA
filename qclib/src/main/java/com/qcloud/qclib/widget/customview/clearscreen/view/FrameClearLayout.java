 ...
 * 类说明：封装帧布局
 * Author: Kuzan
 * Date: 2017/8/23 11:07.
 */
public class FrameClearLayout extends FrameLayout implements IClearRootView {
    ...
    public FrameClearLayout(Context context) {
        this(context, null);
    }

    public FrameClearLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public FrameClearLayout(Context context, AttributeSet attrs, int defStyle) {
