...
public class TimePicker extends DateTimePicker {
    public TimePicker(Context context) {
        this(context, NONE, HOUR_24);
    }

    public TimePicker(Context context, @TimeMode int timeMode) {
        this(context, NONE, timeMode);
    }

    public TimePicker(Context context, @DateMode int dateMode, @TimeMode int timeMode) {
        super(context, dateMode, timeMode);
    }
