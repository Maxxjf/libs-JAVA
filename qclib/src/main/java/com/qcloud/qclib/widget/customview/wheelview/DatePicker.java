...
public class DatePicker extends DateTimePicker {
    public DatePicker(Context context) {
        this(context, YEAR_MONTH_DAY, NONE);
    }

    public DatePicker(Context context, @TimeMode int timeMode) {
        this(context, YEAR_MONTH_DAY, timeMode);
    }

    public DatePicker(Context context, @DateMode int dateMode, @TimeMode int timeMode) {
