...
import com.qcloud.qclib.widget.customview.wheelview.entity.WheelItem;
...
public class WheelView extends View {
    ...
    public void setPadding(int padding) {
        this.padding = ConvertUtil.toPx(getContext(), padding);
    }
    ...
    private void remeasure() {
        ...
        if (useWeight) {
            ...
            if (padding < 0) {
                padding = ConvertUtil.toPx(getContext(), ITEM_PADDING);
            }
        ...
        Log.d("WheelView", "measuredWidth=" + measuredWidth + ",measuredHeight=" + measuredHeight);
